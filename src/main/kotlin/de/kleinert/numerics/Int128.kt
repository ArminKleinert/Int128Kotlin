...
data class Int128(val high: ULong, val low: ULong) : Comparable<Int128>, Number() {
    ...
    operator fun rangeUntil(other: Int128) = Int128Range(this, if (this <= other) other else other.increment())
